...
No too many tricks. Just make sure you are good at ARM architecture.
...
## 2. Solution
  * Review code in `leg.c`. You can see just make sure that `key1()+key2()+key3()) == key` where the value of `key` depends on your input.
